...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/26 12:31:48 by faozturk          #+#    #+#             */
/*   Updated: 2022/04/26 12:31:56 by faozturk         ###   ########.tr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	size_window_init(t_game *game)
{
	...
	game->map_w = ft_strlen(game->map[0]) * 32; // map genişliği yani satırdaki eleman sayısı * 32(kutucuğun boyutu)
	i = 0;
	while (game->map[i] != NULL)
		i++;
	game->map_h = i * 32; // map uzunluğu yani sütundaki eleman sayısı * 32
}
...
void	game_init(t_game *game)
{
	...
	game->win = mlx_new_window(game->mlx, game->map_w, game->map_h, "so_long"); // ekranda yeni bir pencere yaratır. win pencere tanımlayıcıdır.
